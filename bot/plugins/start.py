        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton('🔖  Projects Channel', url='https://t.me/Zee_Keralam_HD')
                ],
                [
                    InlineKeyboardButton('💡  Source Code', url='https://t.me/Zee_Keralam_HD'),
                    InlineKeyboardButton('👨  Master', url='https://t.me/Cristiano_R0naldo_7')
                ]
            ]
        )
    )
